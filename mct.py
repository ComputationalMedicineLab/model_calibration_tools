...
def plot_calibration_curve(x_values,
    ...
    lines.extend(ax.plot(x_values, calibration, label='Estimated Calibration'))
    ...
    if inc_sources:
        ...
        lines.extend(ax.plot(x_values, pos_intensity, 'C1', alpha=0.4, label='Positive Intensity'))
        lines.extend(ax.plot(x_values, all_intensity, 'C2', alpha=0.4, label='All Intensity'))
...
def display_calibration(probs, actual,
    ...
    x_values, curve, pos_intensity, all_intensity = kde_calibration_curve(
        probs,
        actual,
    ...
    ax1 = plot_calibration_curve(
        ...
        all_intensity=all_intensity if include_intensities else None,
        label=label,
        ax=ax1
    )
    ax1.set_xlabel('')
